...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/steep-forest-2ca6)
...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/steep-forest-2ca6#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/steep-forest-2ca6
```

A live public deployment of this template is available at [https://steep-forest-2ca6.templates.workers.dev](https://steep-forest-2ca6.templates.workers.dev)
